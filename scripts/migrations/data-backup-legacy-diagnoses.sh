...
BACKUP_FILE="$(dirname "${BASH_SOURCE[0]}")/backup_BAH-4728_$(date +%Y%m%d_%H%M%S).sql"
...
echo ""
echo "============================================================"
echo "  BAH-4728: Pre-Migration Backup"
echo "============================================================"
echo ""
echo "  Tables : obs, encounter_diagnosis"
...
echo "    ./data-migrate-legacy-diagnoses.sh (same connection args)"
echo ""
